...
export function NavbarDefault() {
  ...
  return (
    <Navbar className="mx-start max-w-[250px] px-4 lg:px-8 lg:py-4 h-[100vh] bg-[#0B1427]">
      <div className="container flex flex-col gap-[20px] text-center text-blue-gray-900">
        <Link to={'/'}>
          <Typography
            as="a"
            href="#"
            className="mr-4 cursor-pointer py-1.5 font-medium w-[201.5px] text-white"
          >
            Material Tailwind
          </Typography>
        </Link>
        <div className="hidden lg:block">{navList}</div>
        <div className="flex flex-col gap-[20px] items-center gap-x-1">
