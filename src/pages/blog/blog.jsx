...
const App = () => {
  return (
    <div>
      ...
      <div>
        ...
        <div className="flex gap-8 p-[30px] m-auto justify-center">
          <div className="w-[400px] mb-4">
            ...
            <h1>Ваш телефон*</h1>
            <Input type="password" label="+7( __ ) __ - _ - _"></Input>
            <div className="flex">
              <Checkbox></Checkbox>
      ...
      <div className="bg-[#0B1427] text-white mt-7 p-[40px] items-center flex flex-col gap-[40px]">
        ...
        <div className="flex  flex-col gap-[20px]">
          ...
          <div className="flex px-[300px] justify-between items-center ">
            <a
